...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('oprice')); ?>:</b>
	<?php echo CHtml::encode($data->oprice); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('cprice')); ?>:</b>
	<?php echo CHtml::encode($data->cprice); ?>
	<br />

	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('swap')); ?>:</b>
	<?php echo CHtml::encode($data->swap); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('osl')); ?>:</b>
	<?php echo CHtml::encode($data->osl); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('csl')); ?>:</b>
	<?php echo CHtml::encode($data->csl); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('ctp')); ?>:</b>
	<?php echo CHtml::encode($data->ctp); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('lpips')); ?>:</b>
	<?php echo CHtml::encode($data->lpips); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('ppips')); ?>:</b>
	<?php echo CHtml::encode($data->ppips); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('dealrisk')); ?>:</b>
	<?php echo CHtml::encode($data->dealrisk); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('oreason')); ?>:</b>
	<?php echo CHtml::encode($data->oreason); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('creason')); ?>:</b>
	<?php echo CHtml::encode($data->creason); ?>
	<br />
