 ...
 */
/*
document.onmousemove = function(ev){ // גûחמג טח /admin/js/script.js
    if (currenttable && currenttable.dragObject) {
        ...
        if (y != currenttable.oldY) {
            ...
            currenttable.dragObject.style.backgroundImage = 'url(/admin/images/trans50.png)';
...
document.onmouseup   = function(ev){
    if (currenttable && currenttable.dragObject) {
        ...
        currenttable.dragObject.style.backgroundImage = '';
...
function initTableDnD()
{
	...
	{
		var table = oTables[i];
		if(null == table.className || -1 == table.className.indexOf('tableDnD')) continue;
...
if (root){
	if (root.addEventListener) root.addEventListener("load", initTableDnD, false);
	else if (root.attachEvent) root.attachEvent("onload", initTableDnD);
}