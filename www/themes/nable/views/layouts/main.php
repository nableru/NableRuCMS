	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
                ...
                array('label'=>'Manage Users', 'url'=>array('/user/user/index'), 'visible'=>!Yii::app()->user->isGuest),
                array('label'=>'sRBAC', 'url'=>array('/srbac/authitem/frontpage'), 'visible'=>!Yii::app()->user->isGuest),
